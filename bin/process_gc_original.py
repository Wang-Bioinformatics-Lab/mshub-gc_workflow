...
def main():
    ...
    parser.add_argument('-import_script', help='import_script', default="bin/proc/io/importmsdata.py")
    parser.add_argument('-align_script', help='align_script', default="bin/proc/preproc/intrapalign.py")
    parser.add_argument('-noise_script', help='noise_script', default="bin/proc/preproc/noisefilter.py")
    parser.add_argument('-interalign_script', help='interalign_script', default="bin/proc/preproc/interpalign.py")
    parser.add_argument('-peakdetect_script', help='peakdetect_script', default="bin/proc/preproc/peakdetect.py")
    parser.add_argument('-export_script', help='export_script', default="bin/proc/io/export.py")
    parser.add_argument('-report_script', help='report_script', default="bin/proc/io/report.py")
    parser.add_argument('-vistic_script', help='vistic_script', default="bin/proc/vis/vistic.py")
    args = parser.parse_args()
    
    parameters_file = open(args.proteosafe_parameters, 'r')
    workflow_params = proteosafe.parse_xml_file(parameters_file) 
    ...
    #output detection
    cmds.append([args.python_runtime, args.export_script, hdf5_filename, folder_path])
